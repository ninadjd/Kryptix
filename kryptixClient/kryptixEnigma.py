def userAuthFunction(username, tagNumber, privateKey, publicKey):
    ...
    if username in privateKey and tagNumber in privateKey:
        realPublicKey = public_key_converter(privateKey)
